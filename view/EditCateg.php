<?php 
	...
	require_once('../model/edit-categ.php');
	$num=1;
?>
<!DOCTYPE html>
<html>
	  ...
	  <div class="modal-dialog" role="document">
	    ...
	    <div class="modal-content">
	      <div class="modal-header">
	        <h2 class="modal-title" id="exampleModalLabel">Edition <span style="font-weight: bold;color:black"> <?= $userinfo['designation']; ?></span></h2>
	      </div>
	      <form method="post" action="">
		      ...
		      <div class="modal-footer">
		        ...
		        <a href="categorie.php" class="btn btn-danger">Fermer</a>
		      </div>
		  </form>
		    </div>
	  </div>
