<?php 
	...
	require_once('../model/Edit-boutique.php');
	$num=1;
?>
<!DOCTYPE html>
<html>
		      ...
		      <div class="modal-body">
		        <div class="form-group">
								  <label for="completename" style="font-size: 20px">Nom Boutique:</label>
								        ...
								        <div class="form-group">
										  <label for="completename" style="font-size: 20px">Monaie:</label>
										            <input type="text" name="monaie"  class="form-control" placeholder="Entrer le nom de l'article" value="<?= $userinfo['monaie'] ?>">
								        </div>
		      <div class="modal-footer">
		        <button class="btn btn-success" type="submit" name="save">Edition</button>
		        <a href="creer-boutique.php" class="btn btn-danger">Fermer</a>
		      </div>
		  </form>
		    </div>
	  </div>
