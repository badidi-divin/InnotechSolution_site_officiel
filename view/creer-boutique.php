<?php 
	...
	require_once('../model/select-boutique-user.php');
	require_once('../model/ajout-boutique.php');
	$num=1;
?>
<!DOCTYPE html>
<html>
			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
													...
													<div class="img-container">
													 <form method="post" action="" enctype="multipart/form-data">
													 	<div class="form-group">
													 		<input type="text" name="nom" placeholder="Entrer le Titre de la Boutique" class="form-control" required="required">
													 	</div>
													 	<div class="form-group">
													 		<input type="text" name="monaie" placeholder="Personaliser le Monaie de la Boutique:CDF,USD,..." class="form-control" required="required">
													 	</div>
													 	<div class="form-group">
													 		<textarea type="text" class="form-control" placeholder="A quoi consistera votre Boutique -- Soyez Bref svp" name="description" required="required"></textarea>
													 	</div>
													 	<div class="form-group">

													 	<input type="file" title="logo" name="photo" placeholder="Entrer le Titre de la Boutique" class="form-control" required="required">
													 	</div>
													 	<div class="form-group">
													 		<input type="text" name="categorie" placeholder="Entrer la catégorie de votre Boutique:Ex: Immobilier" class="form-control" required="required">
													 	</div>
													</div>
												</div>
					...
					<div class="card-box mb-30">
						<div class="pd-20">
							<h4 class="text-blue h4">Liste de vos Boutiques - Vous devez être <a href="../includes/pdf/Pourquoi être certifié.pdf" target="_blank">certifié </a>Pour vendre sans nous!</h4>
						</div>
						<div class="pb-20">
