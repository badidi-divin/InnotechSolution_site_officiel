<?php 
	...
	require_once('../model/select-reduction.php');
	require_once('../model/ajout-reduction.php');
	$num=1;
?>
<!DOCTYPE html>
<html>
			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
													...
													<div class="img-container">
													 <form method="post" action="">
													 	<div class="col-md-6 col-sm-12">
													 		...
													 		<input type="number" name="prix" placeholder="Réduction en %" class="form-control">
														</div>
													</div>
												</div>
					...
					<div class="card-box mb-30">
						<div class="pd-20">
							<h4 class="text-blue h4">Liste des Réductions: (<?php
									$nbcontact=$pdo->prepare('SELECT * FROM reduction');
									$nbcontact->execute();
								...
								<table class="table hover multiple-select-row data-table-export nowrap">
									...
									<tbody>
										...
										<tr>
											...
											<td><?php  echo($et['id_user'])?></td>
											<td><?php  echo($et['prix'])?></td>
											<td><?php  echo($et['dates'])?></td>
											<td>
												<a href="EditReduction.php?id=<?php echo($et['id'])?>"
											class="btn btn-primary"
											title="Modifier Catégorie"
											><i class="fa fa-pencil"></i
										 ></a>
												<a title="Voulez-vous supprimer?" onclick="return confirm('Etes-vous sûre...?');" class="btn btn-danger" href="../model/SupprimeReduction.php?id=<?php echo($et['id'])?>"><i class="fa fa-trash"></i
										></a>
											</td>
										</tr>
										<?php
									...
									<ul class="pagination pagination-md">
										<?php for($i=1;$i<=$nbrePage;$i++) {?>
											<li class="<?php if($i==$page) echo 'active';?>"> 
												<a href="reduction-admin.php?page=<?php echo $i; ?>" class="btn btn-outline-primary"> 
													Page<?php echo $i ?>	
												</a>
											</li>
										 <?php } ?>
