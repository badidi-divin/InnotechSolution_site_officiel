<?php 
	...
	require_once('../model/select-pdf.php');
	require_once('../model/ajout-pdf.php');
			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="card-box mb-30">
						<div class="pd-20">
							<h4 class="text-blue h4">Liste des Pdf: (<?php
									$nbcontact=$pdo->prepare('SELECT * FROM pdf');
									$nbcontact->execute();
								...
								<table class="table hover multiple-select-row data-table-export nowrap">
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="../includes/pdf/<?php echo($et['pdf'])?>" target="_blank"><?php  echo($et['pdf'])?></a></td>
											<td><?php  echo($et['dates'])?></td>
											<td>
												<a href="EditPdf.php?id=<?php echo($et['id'])?>"
											class="btn btn-primary"
											title="Modifier Catégorie"
											><i class="fa fa-pencil"></i
										 ></a>
												<a title="Voulez-vous supprimer?" onclick="return confirm('Etes-vous sûre...?');" class="btn btn-danger" href="../model/Supprimepdf.php?id=<?php echo($et['id'])?>"><i class="fa fa-trash"></i
										></a>
											</td>
										</tr>
										<?php
									...
									<ul class="pagination pagination-md">
										<?php for($i=1;$i<=$nbrePage;$i++) {?>
											<li class="<?php if($i==$page) echo 'active';?>"> 
												<a href="setting-pdf.php?page=<?php echo $i; ?>" class="btn btn-outline-primary"> 
													Page<?php echo $i ?>	
												</a>
											</li>
										 <?php } ?>
