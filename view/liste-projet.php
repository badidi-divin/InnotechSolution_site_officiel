<?php 
	...
	require_once('../model/select-projetuser.php');
	require_once('../model/ajout-projet.php');
	$num=1;
?>
<!DOCTYPE html>
<html>
								...
								>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="EditProjet.php?id=<?php echo($et['id_projet'])?>"
											class="btn btn-primary"
										...
										></a>
										<a title="Voulez-vous envoyé un message"   href="./gere_message-user.php?id=<?php echo($et['id_projet'])?>" class="btn btn-primary"><i class="fa fa-comment"></i
											><?php
