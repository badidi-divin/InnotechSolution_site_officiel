<?php 
    ...
    $id=strip_tags($id);
    require_once('../model/functions2.php');
         $success=array();
    if (!empty($_POST)){
        ...
        if (empty($comment)) 
          array_push($errors, 'Entrer un commentaire');
              ...
              if (count($errors)==0){
                    ...
                    $comment=addComment_service($id,$auteur,$comment);
  ...
  $blogs_service=getservices($id); 
  $comments_service=getComments_service($id);
...
<html>
					...
					<div class="page-header">
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<div class="title">
									<h4>Detail Service:<?php echo $blogs_service->nom; ?></h4>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="row">
								<div class="col-md-8 col-sm-12">
									<div class="blog-detail card-box overflow-hidden mb-30">
										<div class="blog-img">
											<img src="../includes/images/<?php echo $blogs_service->image; ?>" alt="" />
										</div>
										<div class="blog-caption">
											<h4 class="mb-10">
												<?php echo $blogs_service->nom; ?>
											</h4>
											<p>
												<?php echo $blogs_service->description; ?>
											</p>
											<p>
												Date de Début: <?php echo $blogs_service->dates; ?>
											</p>
            ...
            <div class="row no-gutters">
              <div class="col-lg-8 col-md-7 order-md-last d-flex align-items-stretch">
                <div class="contact-wrap w-100 p-md-5 p-4">
                  ...
                  <form method="POST" id="contactForm" action="detailService.php?id=<?=$blogs_service->id;?>" class="contactForm">
                        <?php
                    if (!empty($erreur)):
                  ?>
    ...
    <?php foreach ($comments_service as $com): ?>
      <div class="right">
